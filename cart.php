...
?>
    ...
    <section class="ptb-70">
        <form class="container" action="cart.php" method="post">
            <div class="row">
                <div class="col-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-box select-dropdown">
                                                    <fieldset>
                                                        <select data-id="100" class="quantity_cart option-drop" name="quantite<?=$i?>">
                                            ...
                                            <input type="hidden" name="prod<?=$i?>" value="<?=$produit->id?>">
                                            <td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mt-30 right-side float-none-xs">
                            <button class="btn btn-color" name="updateCart">Update Cart</button>
                        </div>
                    </div>
                </div>
            </div>
