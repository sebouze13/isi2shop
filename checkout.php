          ...
          <div class="checkout-content" >
            ...
            <div class="row justify-content-center">
              <div class="col-xl-6 col-lg-8 col-md-8">
                <form action="http://aaryaweb.info/html/stylexpo/stx002/order-overview.html" class="main-form full">
                  <div class="row mb-20">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12"> 
                      <a href="order-overview.php" class="btn btn-color right-side">Next</a>
                    </div>
                  </div>
                </form>
              </div>
