        ...
        <div class="col-lg-9">
          <div class="shorting mb-30">
            <div class="row">
              <div class="col-lg-6">
                <div class="view">
                  <div class="list-types grid"> <a href="shop.php">
                    <div class="grid-icon list-types-icon"></div>
                    </a> 
                  </div>
                  <div class="list-types list active"> <a href="shop-list.php">
          ...
          <div class="product-listing list-type">
            <div class="row">
              <div class="col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="product-page.php"> <img src="images/1.jpg" alt="Stylexpo"> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> 
                      <a href="product-page.php">Cross Colours Camo Print </a>
                    </div>
                    <div class="rating-summary-block">
              ...
              <div class="col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/2.jpg" alt="Stylexpo"> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print </a> </div>
                    <div class="rating-summary-block">
                      <div title="53%" class="rating-result"> <span style="width:53%"></span> </div>
                    </div>
                    <div class="price-box"> <span class="price">$80.00</span> <del class="price old-price">$100.00</del> </div>
              ...
              <div class="col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/3.jpg" alt="Stylexpo"> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
              ...
              <div class="col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/4.jpg" alt="Stylexpo"> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
              ...
              <div class="col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/5.jpg" alt="Stylexpo"> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
              ...
              <div class="col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/6.jpg" alt="Stylexpo"> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
              ...
              <div class="col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/7.jpg" alt="Stylexpo"> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
              ...
              <div class="col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/8.jpg" alt="Stylexpo"> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
